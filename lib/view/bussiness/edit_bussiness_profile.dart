...
class _EditBussinessProfileState extends State<EditBussinessProfile> {
  ...
  Widget build(BuildContext context) {
    var userProvider = context.watch<BussinessController>().singleShopData;

    _nameController.text = "${userProvider.ownerName}";
    _lastNameController.text = userProvider.businessName.toString();
                    ...
                    Container(
                      ...
                      child: _image == null
                          ? CachedNetworkImage(
                              fit: BoxFit.cover,
                              imageUrl:
                                  "${Constants.BASE_URL}/${userProvider.logo}",
